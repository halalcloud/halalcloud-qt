...
set ObjectFolder="%~dp0Output\Objects\Tools\x64"
set BinaryFolder="%~dp0Output\Binaries\Tools\x64"
...
set CommonOptions=%CommonOptions% -DCMAKE_CONFIGURATION_TYPES=Release
